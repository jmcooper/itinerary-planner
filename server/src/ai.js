...
- The "Flight trips" JSON in the trip state is the complete set of recorded bookings — resend exactly that list plus/minus what the traveler asked to change. NEVER invent an entry from itinerary items, day descriptions, or earlier conversation: a flight mentioned in the itinerary text is not a booking. If you notice such a flight isn't recorded, you may ask the traveler whether to record it — never add it unasked.
